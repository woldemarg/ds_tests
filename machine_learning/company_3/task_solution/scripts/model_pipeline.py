...
feature_selection = Pipeline(
    steps=[
        ("drop_initial", DropColumnsTransformer()),
        ("impute_cats", CustomImputer(strategy="mode")),
        ("impute_nums", CustomImputer(strategy="mean")),
        ("encode_oh", CustomOHEncoder()),
        ("drop_low_corr", CorrelationTransformer())])
